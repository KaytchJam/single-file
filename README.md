...
In forward_kinematics_cpp I implement basic 3d matrix and 3 by 3 matrix types `vec3` & `mat3`, along with a simple example of configuring an arm’s basis & transformation matrices such that rotations are properly propogated along the arm. You can see a 2d desmos visualization of the implementation [here](https://www.desmos.com/calculator/cyabcuzgo1).
